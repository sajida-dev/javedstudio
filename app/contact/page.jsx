    ...
    <>
      ...
      <section className="mb-32">
        <div id="map" className="relative h-[300px] overflow-hidden bg-cover bg-[50%] bg-no-repeat">
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3372.9038585949515!2d72.27892!3d32.287562699999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39213dba0d890465%3A0x8a0a82512dc6a260!2sJaved%20Studio!5e0!3m2!1sen!2s!4v1743272269215!5m2!1sen!2s" width="100%" height="480" style={{ border: "0" }} allowFullScreen loading="lazy" referrerpolicy="no-referrer-when-downgrade" />
        </div>
              ...
              <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                <form>
                  <div className="relative mb-6" data-te-input-wrapper-init="">
                    <input type="text" className="peer block min-h-[auto] w-full border-b-2 border-amber-400 bg-transparent py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none " id="exampleInput90" />
                  ...
                  <div className="relative mb-6" data-te-input-wrapper-init="">
                    <input type="email" className="peer block min-h-[auto] w-full border-b-2 border-amber-400 bg-transparent py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none " id="exampleInput91" />
                  ...
                  <div className="relative mb-6" data-te-input-wrapper-init="">
                    <textarea className="peer block min-h-[auto] w-full border-b-2 border-amber-400 bg-transparent py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none " id="exampleFormControlTextarea1" rows={3} />
                ...
                <div className="flex flex-wrap">
                  ...
                  <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-6/12 md:px-3 lg:mb-12 lg:w-full lg:px-6 xl:w-6/12">
                    <div className="align-start flex">
                      <div className="shrink-0">
                        <div className="inline-block rounded-md bg-amber-200 p-4 text-primary">
                          {/* <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" className="w-7 h-7" viewBox="0 0 111.756 122.879" enableBackground="new 0 0 111.756 122.879" space="preserve">
                            <g>
                      ...
                      <div className="ml-6 grow">
                        ...
                        <p className="text-neutral-500"> +92 (300) 8074904
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:mb-12 xl:w-6/12">
                    <div className="align-start flex">
                      ...
                      <div className="ml-6 grow">
                        ...
                        <p className="text-neutral-500"> +92 (300) 7784807
                        </p>
                      </div>
                    </div>
                  </div>
