                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                    {teamMembers.map((member, index) => (
                        <div key={index} className="group relative p-6">
                            ...
                            />
                            <div className="absolute -bottom-12 left-1/2 transform -translate-x-1/2 p-5 w-[80%] bg-white shadow-xl  text-center overflow-hidden z-10 group-hover:bg-amber-500 group-hover:text-white transition-all duration-300">
