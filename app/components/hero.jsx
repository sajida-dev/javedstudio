        ...
        <>
            ...
            >
                ...
                <div className="relative py-12 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                    ...
                    <h3 className="mb-4 text-1xl font-extrabold tracking-tight leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-white">ARE YOU LOOKING FOR BEST WEDDING PHOTOGRAPHERS IN PAKISTAN?</h3>
