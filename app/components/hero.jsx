...
const Hero = () => {
    return (
        <>
            <section className="bg-white dark:bg-gray-900 pt-10 pb-20">
                <div className="py-12 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                    ...
                    <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                        <a href="#" className="text-gray dark:text-white inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                            Learn more
                    ...
                    <div className="max-w-2xl max-md:max-w-md mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 items-center mt-6">
                        <a href="https://www.instagram.com/javedstudio751/"><img src="https://github.com/sajida-dev/javedstudio/raw/master/app/images/insta-logo.png" className="w-28 mx-auto" alt="google-logo" /></a>
                        <a href="https://www.facebook.com/profile.php?id=61564252206804&mibextid=ZbWKwL"><img src="https://readymadeui.com/facebook-logo.svg" className="w-28 mx-auto" alt="facebook-logo" /></a>
