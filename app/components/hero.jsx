        ...
        <>
            <section className="bg-white dark:bg-gray-900 pt-10 pb-20">
                <div className="py-12 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                    ...
                    <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Javed Studio offers professional photography and videography services for weddings, events, corporate shoots, and more.
