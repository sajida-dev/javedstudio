...
//         <div className='m-5'>
//             {clients.map((client) => (
//                 <div key={client.id} className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
...
//                                 <svg className="absolute top-0 start-0 transform -translate-x-8 -translate-y-4 size-24 text-gray-200 " width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
