...
const Testimonials = () => {
    ...
    return (
        <div className='m-5 relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto'>
            <div className="md:grid md:grid-cols-2 md:gap-10 lg:gap-16 md:items-center">
                ...
                <div>
                    <blockquote className="relative">
                        <svg className="absolute top-0 start-0 transform -translate-x-8 -translate-y-4 size-24 text-gray-200"
                        ...
                        <div className="relative z-10">
                            <p className="text-xs font-semibold text-gray-500 uppercase mb-3">Featured client</p>
            ...
            {/* Navigation Buttons */}
            <button className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full" onClick={prevTestimonial}>
                &#9664;
            </button>
            <button className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white p-2 rounded-full" onClick={nextTestimonial}>
                &#9654;
            </button>
        </div>
    );
